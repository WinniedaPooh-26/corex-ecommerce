...
const PRODUCTS = [
  ...
  },
  {
    ...
    image: "tank",
    imageUrl: "images/women_3.png",
    imageQuality: "catalog",
    imageType: "women-top",
    alt: "Premium training tank top.",
    galleryImages: ["images/women_3.png"],
    description: "A lightweight, breathable tank top with a relaxed fit and dropped armholes.",
    features: ["Breathable", "Sweat Wicking", "Light Support", "Relaxed Fit"],
    isBestSeller: true,
    badge: "Best Seller"
  },
  {
  ...
  },
  {
    ...
    image: "active-set",
    imageUrl: "images/women_10.png",
    imageQuality: "catalog",
    imageType: "women-yoga",
    alt: "Model wearing ribbed activewear matching set.",
    galleryImages: ["images/women_10.png"],
  ...
  // ==========================================
  {
    ...
    image: "tee",
    imageUrl: "images/men_1.png",
    imageQuality: "catalog",
    imageType: "men-top",
    alt: "Male activewear gym t-shirt.",
    galleryImages: ["images/men_1.png"],
  ...
  },
  {
    ...
    image: "tank-m",
    imageUrl: "images/men_2.png",
    imageQuality: "catalog",
    imageType: "men-top",
    alt: "Male activewear gym tank top.",
    galleryImages: ["images/men_2.png"],
    description: "A high-performance training tank with dropped armholes and flatlock seams for enhanced breathability.",
    features: ["Dropped Armholes", "Flatlock Seams", "Sweat Wicking"],
    isBestSeller: true,
    badge: "Best Seller"
  },
  {
  ...
  // ==========================================
  {
    ...
    material: "92% Modal, 8% Spandex",
    image: "tank",
    imageUrl: "images/yoga_1.png",
    imageQuality: "catalog",
    imageType: "women-top",
    alt: "Woman wearing racerback yoga tank top.",
    galleryImages: ["images/yoga_1.png"],
    description: "A lightweight, breathable tank top with a relaxed fit and dropped armholes.",
  ...
  },
  {
    ...
    material: "90% Nylon, 10% Elastane",
    image: "rib-leggings",
    imageUrl: "images/yoga_2.png",
    imageQuality: "catalog",
    imageType: "women-bottom",
    alt: "Model standing in ribbed activewear leggings.",
    galleryImages: ["images/yoga_2.png"],
  ...
  },
  {
    ...
    image: "leggings",
    imageUrl: "images/yoga_5.png",
    imageQuality: "catalog",
    imageType: "women-bottom",
    alt: "Model standing wearing premium black flare leggings.",
    galleryImages: ["images/yoga_5.png"],
    description: "Classic flare leggings crafted from buttery-soft fabric for ultimate comfort during stretch.",
    features: ["Flared Fit", "Buttery Soft", "High Rise"],
    badge: null
  },
  {
    id: 26,
  ...
  // ==========================================
  {
    ...
    image: "mat",
    imageUrl: "images/accessories_1.png",
    imageQuality: "catalog",
    imageType: "accessory",
    alt: "Rolled up light blue yoga mat.",
    galleryImages: ["images/accessories_1.png"],
  ...
  },
  {
    ...
    image: "backpack",
    imageUrl: "images/accessories_2.png",
    imageQuality: "catalog",
    imageType: "accessory",
    alt: "Black gym backpack.",
    galleryImages: ["images/accessories_2.png"],
  ...
  },
  {
    ...
    image: "bottle",
    imageUrl: "images/accessories_3.png",
    imageQuality: "catalog",
    imageType: "accessory",
    alt: "Stainless steel water bottle.",
    galleryImages: ["images/accessories_3.png"],
  ...
  },
  {
    ...
    image: "bands",
    imageUrl: "images/accessories_4.png",
    imageQuality: "catalog",
    imageType: "accessory",
    alt: "Beige yoga strap.",
    galleryImages: ["images/accessories_4.png"],
  ...
  },
  {
    ...
    image: "block",
    imageUrl: "images/accessories_5.png",
    imageQuality: "catalog",
    imageType: "accessory",
    alt: "Beige yoga block.",
    galleryImages: ["images/accessories_5.png"],
  ...
  },
  {
    ...
    image: "roller",
    imageUrl: "images/accessories_6.png",
    imageQuality: "catalog",
    imageType: "accessory",
    alt: "Black foam roller.",
    galleryImages: ["images/accessories_6.png"],
  ...
  },
  {
    ...
    image: "bands",
    imageUrl: "images/accessories_7.png",
    imageQuality: "catalog",
    imageType: "accessory",
    alt: "Plum resistance band.",
    galleryImages: ["images/accessories_7.png"],
  ...
  },
  {
    ...
    image: "cap",
    imageUrl: "images/accessories_8.png",
    imageQuality: "catalog",
    imageType: "accessory",
    alt: "White sports cap.",
    galleryImages: ["images/accessories_8.png"],
  ...
  },
  {
    ...
    image: "socks",
    imageUrl: "images/accessories_9.png",
    imageQuality: "catalog",
    imageType: "accessory",
    alt: "White athletic socks.",
    galleryImages: ["images/accessories_9.png"],
  ...
  },
  {
    ...
    image: "towel",
    imageUrl: "images/accessories_10.png",
    imageQuality: "catalog",
    imageType: "accessory",
    alt: "Grey microfibre fitness towel.",
    galleryImages: ["images/accessories_10.png"],
  ...
  // ==========================================
  {
    ...
    material: "85% Cotton, 15% Polyester",
    image: "jacket",
    imageUrl: "images/new-arrivals_1.png",
    imageQuality: "catalog",
    imageType: "women-top",
    alt: "Beige activewear zip jacket.",
    galleryImages: ["images/new-arrivals_1.png"],
  ...
  },
  {
    ...
    image: "leggings",
    imageUrl: "images/new-arrivals_2.png",
    imageQuality: "catalog",
    imageType: "women-bottom",
    alt: "Model standing wearing sculpt leggings.",
    galleryImages: ["images/new-arrivals_2.png"],
  ...
  },
  {
    ...
    image: "tee",
    imageUrl: "images/new-arrivals_3.png",
    imageQuality: "catalog",
    imageType: "men-top",
    alt: "Male athletic tee shirt.",
    galleryImages: ["images/new-arrivals_3.png"],
  ...
  },
  {
    ...
    image: "shorts-m",
    imageUrl: "images/new-arrivals_4.png",
    imageQuality: "catalog",
    imageType: "men-bottom",
    alt: "Male activewear hybrid shorts.",
    galleryImages: ["images/new-arrivals_4.png"],
  ...
  },
  {
    ...
    material: "78% Nylon, 22% Spandex",
    image: "bra",
    imageUrl: "images/new-arrivals_5.png",
    imageQuality: "catalog",
    imageType: "women-yoga",
    alt: "Seamless mauve sports bra.",
    galleryImages: ["images/new-arrivals_5.png"],
  ...
  },
  {
    ...
    material: "80% Nylon, 20% Spandex",
    image: "leggings",
    imageUrl: "images/new-arrivals_6.png",
    imageQuality: "catalog",
    imageType: "women-bottom",
    alt: "Model wearing mauve flared leggings.",
    galleryImages: ["images/new-arrivals_6.png"],
    description: "Flared leggings in a beautiful mauve shade, designed with a crossover waistband.",
    features: ["Crossover Waist", "Flared Ankle", "Buttery Feel"],
    isNewArrival: true,
    badge: "New"
  },
  {
    ...
    material: "85% Cotton, 15% Polyester",
    image: "jacket",
    imageUrl: "images/new-arrivals_7.png",
    imageQuality: "catalog",
    imageType: "women-top",
    alt: "Cropped sports hoodie.",
    galleryImages: ["images/new-arrivals_7.png"],
  ...
  },
  {
    ...
    image: "tank-m",
    imageUrl: "images/new-arrivals_8.png",
    imageQuality: "catalog",
    imageType: "men-top",
    alt: "Male athlete in gym tank.",
    galleryImages: ["images/new-arrivals_8.png"],
    description: "New activewear training tank with split side hems for heavy squats and dynamic lifts.",
    features: ["Split Hems", "Drop Armholes", "Breathable Knit"],
    isNewArrival: true,
    badge: "New"
  },
  {
    ...
    material: "82% Nylon, 18% Spandex",
    image: "active-set",
    imageUrl: "images/new-arrivals_9.png",
    imageQuality: "catalog",
    imageType: "women-yoga",
    alt: "Sage green matching set.",
    galleryImages: ["images/new-arrivals_9.png"],
  ...
  },
  {
    ...
    material: "88% Polyester, 12% Spandex",
    image: "joggers",
    imageUrl: "images/new-arrivals_10.png",
    imageQuality: "catalog",
    imageType: "men-bottom",
    alt: "Male model in gym training pants.",
    galleryImages: ["images/new-arrivals_10.png"],
  ...
  },
  {
    ...
    material: "92% Modal, 8% Spandex",
    image: "tank",
    imageUrl: "images/sale_3.png",
    imageQuality: "catalog",
    imageType: "women-top",
    alt: "Premium training tank top on sale.",
    galleryImages: ["images/sale_3.png"],
    description: "A lightweight, breathable tank top with a relaxed fit and dropped armholes.",
    features: ["Breathable", "Sweat Wicking", "Sale Item"],
    isSale: true,
    badge: "Sale"
  },
  {
...
function loadFromStorage() {
  const cartData = localStorage.getItem("corex_cart");
  const wishlistData = localStorage.getItem("corex_wishlist");
  const userData = localStorage.getItem("corex_user");

  if (cartData) state.cart = JSON.parse(cartData);
  if (wishlistData) state.wishlist = JSON.parse(wishlistData);
  if (userData) state.currentUser = JSON.parse(userData);

  // Initialize cart with mockup items if empty for demo presentation
  if (state.cart.length === 0) {
    state.cart = [
      {
        product: PRODUCTS[1], // Flow Leggings
        size: "M",
        color: PRODUCTS[1].colors[0], // Mauve
        quantity: 1
      },
      {
        product: PRODUCTS[0], // Sports Bra
        size: "S",
        color: PRODUCTS[0].colors[1], // Black
        quantity: 1
      }
    ];
    saveToStorage();
...
function navigateTo(view, params = {}) {
  ...
  if (view === "home") {
    ...
    const matches = document.querySelectorAll(`.nav-link[data-category="${cat}"]`);
    matches.forEach(m => m.classList.add("active"));
    
    renderShopView();
  } else if (view === "detail") {
    if (params.id) {
      let prod = PRODUCTS.find(p => p.id === parseInt(params.id));
      if (prod) {
        // Do not transform a normal product into a sale item here.
        // Its original tag (including Best Seller) must match the menu/catalog card.
